    ...
    def sync_sap(self):
        ...
        if var:
            for r in self:
                ...
                dic['billTo']=r.partner_id.street+' ' + (r.partner_id.city if r.partner_id.city else '')+' '+(r.partner_id.country_id.name if r.partner_id.country_id else '')
                dic['shipTo']=r.unispice_sociedad_id.name+' NIT:'+(r.unispice_sociedad_id.vat if r.unispice_sociedad_id.vat else '')+' '+(r.unispice_sociedad_id.street if r.unispice_sociedad_id.street else '')
